...
export default async function TermsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-24 sm:px-6 lg:px-8 font-sans w-full overflow-x-hidden">
      <div className="glass rounded-3xl p-5 sm:p-8 md:p-12 lg:p-16">
        <header className="mb-12 border-b border-foreground/10 pb-8">
          <h1 className="text-3xl md:text-5xl font-heading font-bold mb-3 text-foreground break-words">
            {t("title")}
          </h1>
          <p className="text-lg md:text-xl text-foreground/70 mb-4 font-medium italic break-words">
            {t("subtitle")}
          </p>
        ...
        <div className="space-y-12">
          {Object.entries(sections).map(([key, section]) => (
            <section key={key} id={key} className="scroll-mt-24">
              ...
              <div className="text-foreground/80 leading-relaxed whitespace-pre-wrap space-y-4 break-words">
                {section.content}
              </div>
            </section>
          ))}
