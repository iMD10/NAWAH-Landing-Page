        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1 max-w-xl">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-8 py-4 rounded-full font-bold text-sm transition-all duration-300 hover:-translate-y-0.5"
              style={{
                background: "linear-gradient(135deg, var(--color-navy), var(--color-blue))",
                color: "#ffffff",
                boxShadow: "0 8px 32px var(--border-blue)",
            ...
            >
              ...
              <div>
                <div className="text-[10px] opacity-70 leading-none">{t("playStorePre")}</div>
